...
public class SandTraveler
{
  ...
  public SandTraveler()
  {
    ...
    width = Data.image.getWidth();
    height = Data.image.getHeight();
    ...
    Data.graphTmp.fillRect(0, 0, width, height);
  ...
  private void point(double x, double y, int rgb2, double alpha)
  {
    ...
    int rgb1 = Data.imageTmp.getRGB(ix, iy);
    ...
    if (b1 > 255) b1 = 255;
    rgb1 = r1 << 16 | g1 << 8 | b1;
    Data.imageTmp.setRGB(ix, iy, rgb1);
  }
