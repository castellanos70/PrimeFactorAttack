...
/*
 * EndGameScreen_Evan_Pierce is an adapted copy of LevelUpScreen_Luke_Stankus
 */

public class EndGameScreen_Evan_Pierce extends LevelUpScreen
{
  private Graphics2D canvas;
  private boolean done = false;
  private double scale, minX;
  private int width, height, currentCol, fontHeight, backgroundColor;
  private int str2Width, str3Width;
  ...
  private Font myFont = new Font("Optima", Font.BOLD, 65);
  private Font myFont1 = new Font("Optima", Font.ITALIC, 40);
  private int frameCount=0;

  private String str2, str3;

  public EndGameScreen_Evan_Pierce(BufferedImage offscreenBuffer,
                                   String str2, String str3)
  {
    ...
    textColor = new Color(10, 133, 255);
    shadowColor = new Color(254, 14, 1);
    darkColor = new Color(255, 126, 5);
    ...
    FontMetrics fm1 = canvas.getFontMetrics(myFont1);
    fontHeight = fm1.getHeight();
    str3Width = fm1.stringWidth(str3);

    int row2 = 235;
    int row3 = ((height-fontHeight)/2)+95;
